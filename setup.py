...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-stock_shipment_out_edi',
    download_url='https://github.com:nantic/trytond-stock_shipment_out_edi.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-stock_shipment_out_edi.git'
    },
    classifiers=[
